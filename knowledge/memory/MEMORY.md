...
- [Prescribe stakes, not process](feedback-prescribe-stakes-not-process.md) — author states the consequence of failure + why it's hard; the runtime picks the agents/models/gates. Ratings inflate, consequences don't.
